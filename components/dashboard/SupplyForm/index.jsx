    ...
    <Form formHook={formHook} onSubmit={handleSubmit}>
      ...
      {hasData && (
        <>
          ...
          <HookInput
            label={'Spotřebovaných respirátorů ffp3'}
            type={'number'}
            name={'ffp3Consumed'}
            formHook={formHook}
          />
          <HookInput
            label={'Spotřebovaných respirátorů ffp2'}
            type={'number'}
            name={'ffp2Consumed'}
            formHook={formHook}
          />
          <HookInput
            label={'Spotřebovaných ochranných brýlí/štítů'}
            type={'number'}
            name={'shieldConsumed'}
            formHook={formHook}
          />
          <HookInput
            label={'Spotřebovaných ochranných oděvů'}
            type={'number'}
            name={'suitConsumed'}
            formHook={formHook}
          />
          ...
          <HookInput
            label={'Máte dostatek dezinfekce / rukavic na dva týdny?'}
            type={'checkbox'}
            name={'enoughDisinfectionGlovesSupplies'}
            formHook={formHook}
          >
            Ano
          </HookInput>

          <Button small onClick={() => setNewEqVisible(visible => !visible)}>
            Máte nějaké nové pomůcky?
          </Button>
        </>
      )}
      ...
      {(newEqVisible || !hasData) && (
        <div>
          ...
          <div className={styles.group}>
            <HookInput
              label={'Respirátory ffp3'}
              type={'number'}
              name={'ffp3Received'}
              formHook={formHook}
            />
            <HookInput
              label={'Z toho od státu'}
              type={'number'}
              name={'ffp3ReceivedFromState'}
              formHook={formHook}
            />
          </div>
          <div className={styles.group}>
            <HookInput
              label={'Respirátory ffp2'}
              type={'number'}
              name={'ffp2Received'}
              formHook={formHook}
            />
            <HookInput
              label={'Z toho od státu'}
              type={'number'}
              name={'ffp2ReceivedFromState'}
              formHook={formHook}
            />
          </div>
          <div className={styles.group}>
            <HookInput
              label={'Ochranné brýle/štíty'}
              type={'number'}
              name={'shieldReceived'}
              formHook={formHook}
            />
            <HookInput
              label={'Z toho od státu'}
              type={'number'}
              name={'shieldReceivedFromState'}
              formHook={formHook}
            />
          </div>
          <div className={styles.group}>
            <HookInput
              label={'Ochranné oděvy'}
              type={'number'}
              name={'suitReceived'}
              formHook={formHook}
            />
      ...
      <p>
        <Button busy={loading} type={'submit'}>
          {hasData ? 'Aktualizovat data' : 'Vložit data'}
        </Button>
      </p>
    </Form>
  )
