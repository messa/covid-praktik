  ...
  return (
    <Form formHook={formHook} onSubmit={handleSubmit}>
      ...
      <div className={styles.group}>
        <HookInput
          label={'Celkem doktorů'}
          type={'number'}
          name={'doctorTotalCount'}
          formHook={formHook}
        />
        <HookInput
          label={'Z toho v karanténě'}
          type={'number'}
          name={'doctorQuarantinedCount'}
          formHook={formHook}
        />
        <HookInput
          label={'Z toho nemocných'}
          type={'number'}
          name={'doctorSickCount'}
          formHook={formHook}
        />
      </div>
      <div className={styles.group}>
        <HookInput
          label={'Celkem sester'}
          type={'number'}
          name={'nurseTotalCount'}
          formHook={formHook}
        />
        <HookInput
          label={'Z toho v karanténě'}
          type={'number'}
          name={'nurseQuarantinedCount'}
          formHook={formHook}
        />
        <HookInput
          label={'Z toho nemocných'}
