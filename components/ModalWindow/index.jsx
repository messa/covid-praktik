...
const ModalWindow = ({
    ...
    const handleDocumentInteraction = useCallback((e) => {
        if (!canClose || !closeByClickingOut || !contentRef.current || contentRef.current.contains(e.target)) {
            return;
        }
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            window.document.removeEventListener('click', handleDocumentInteraction, true);
