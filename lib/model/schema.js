...
export const SupplyUpdate = createModel('SupplyUpdate', supplyUpdateSchema, 'supplyUpdates')
...
export const DisinfectionState = createModel('DisinfectionState', disinfectionStateSchema, 'disinfectionStates')
...
export const StaffState = createModel('StaffState', staffStateSchema, 'staffStates')
